---
title: "MPS SDK VER 1.1.7"
permalink: ver_1.1.7_index.html
...
<p id="download">
    <a  href="https://github.com/NBCUOTS/mobile_mps_sdk_android_examples/releases/tag/release-1.1.7">Download MPS SDK Examples
    </a>
</p>
...
dependencies {
    ...
    implementation 'com.nbcuni.mps:mps-android:1.1.7'
    ...
}
```
